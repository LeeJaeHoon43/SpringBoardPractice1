					...
					<c:forEach items="${repList}" var="repList">
						<li>
							...
							<div class="form-group">
								...
								<!-- 
									- 게시물에 보여지는 댓글은 다수의 댓글이 한번에 표시되기 때문에, 
										버튼만 추가하면 어느 댓글에 대한 수정/삭제 버튼을 눌렀는지 바로 알아내기가 어렵다.
									- 그래서 버튼에 data속성을 이용하여 댓글 번호(rno)를 부여하고, 
										스크립트에서 $(this).attr("data-rno")를 사용하여 가져올 수 있다. 
									- 여기서 $(this)는 클릭한 요소를 가르킵니다.
								 -->
								<script type="text/javascript">
