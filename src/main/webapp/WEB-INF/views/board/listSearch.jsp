	...
	<div class="container">
		...
		<section id="container">
			...
			<div class="col-md-offset-3">
				<!-- 부트스트랩의 페이징 네비게이션 기능에 현재 페이지의 색을 바꾸는 기능이 포함. -->
				<ul class="pagination"> 
					<c:if test="${pageMaker.prev}">
						<li><a href="listSearch${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
					</c:if>
					<!-- 현재 페이지를 알기 위해, 페이지 메이커(pageMaker)에 포함된 Criteria, 
						 Criteria에 포함된 페이지 번호(page)를 가져와서 선택한 페이지 번호(idx)와 같은지 비교하고,
						 같으면 active 클래스가 적용되고 같지 않다면 아무것도 적용하지 않음. -->
